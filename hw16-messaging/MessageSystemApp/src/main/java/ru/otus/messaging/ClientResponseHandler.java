...
public class ClientResponseHandler implements RequestHandler<ClientRequestAndResponse> {
    private static final Logger logger = LoggerFactory.getLogger(ClientResponseHandler.class);

    private final CallbackRegistry callbackRegistry;

    public ClientResponseHandler(final CallbackRegistry callbackRegistry) {
